...
-- Step 0: Create Custom ENUM Types for Data Integrity
-- -----------------------------------------------------------------
...
-- Step 3: Base Learning Progress Table (without dependencies on assignments)
-- -----------------------------------------------------------------
...
-- Step 5: Session Tables (MOVED to resolve dependency on 'assignments' table)
-- -----------------------------------------------------------------
